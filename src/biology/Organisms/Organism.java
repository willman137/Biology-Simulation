...
import biology.simulation.Polypeptide;
...
public class Organism extends Bug{
    ...
    public Count[] alleleCounts = new Count[testAlleles.length*2];
    ...
    public static String [] testAlleles = {"Aa", "Ii", "Nn","Dd"};
    public String sexChromosomes = "";
    ...
    public Organism() {
        ...
        this.gender = this.setGender_returnString(genders[ranGender]);
        this.sexChromosomes = "";
        ...
        this.generation = 1;
        this.oneChild = false;
        this.maxSteps = (int) (Math.random() * 300) + 75;
    ...
    private void setSexChromosomes()
    {
    ...
    private void bettercrossOver(Organism p1, Organism p2) {
       ...
       String tempGenotype[] = new String[(p1.genotype.length()+p2.genotype.length())/4];
    ...
    public void getAlleleInfo() {
       ...
       //System.out.println("Count object total: "+BiologySimulation.counts.length);//only 7 objects when 9 are needed
       for(int n = 0; n < BiologySimulation.counts.size(); n++){
           text.append("Count object total: "+BiologySimulation.counts.size()+"\n");//only 7 objects when 9 are needed

           text.append(BiologySimulation.counts.get(n).name+"\n"); 
           //sb.append(("Allele "+BiologySimulation.counts[n].name+" Count: "+ BiologySimulation.counts[n].count+"\n"));
       }
       text.setEditable(false);
       text.append(sb.toString());
      
       info.setLocation(1000,450);       
...
//middle number wing type (short/long/average) string
    ...
    public void getInfo() {
       ...
       sb.append(("Sex Chromosomes: "+this.sexChromosomes+"\n"));
    ...
    public static String getHardyWeinburg()
    {
        String ret = "";
